...
public class DeviceForEventDriven {
  ...
  public static String DataSize = "1500";
  ...
  public static String cnt = "20000";
  ...
  public static void main(String[] args) {
    ...
    device.run(strPacketLossRate, cnt, strDataSize);
  ...
  public void run(String strPacketLossRate, String strLoopCount, String strDataSize) {
    ...
    if (statusCode == 200) {
      ...
      if (statusCode == 200) {
        ...
        //startPingOnGSCL("gscl/applications/Ping/process/start");
  ...
  private void CreateTempResource() {
    ...
    try {
      ...
      sb.append(
          ...
          "<om2m:application xmlns:om2m='http://uri.etsi.org/m2m' appId='" + DeviceID + "_Temp'>");
      ...
      url = "http://" + GSCL_IP + ":" + GSCL_Port + "/om2m/gscl/applications/" + DeviceID
      ...
      sb.append("<om2m:searchString>ResourceID/" + DeviceID + "_Temp_" + dataContainerID
      ...
      //			url2 = "http://" + GSCL_IP + ":" + GSCL_Port +

      //"/om2m/gscl/applications";
      ...
      //			httpMethod2.addRequestHeader("Authorization", "Basic
      ...
      //			sb2.append("<om2m:application xmlns:om2m='http://uri.etsi.org/m2m'

      //appId='" + DeviceID2 + "_Temp'>");
      ...
      //			sb2.append("<om2m:searchString>ResourceID/" + DeviceID2 +

      //"_Temp</om2m:searchString>");
      ...
      //			requestEntity2 = new StringRequestEntity(sb2.toString(),
      ...
      //"/om2m/gscl/applications/" + DeviceID2 + "_Temp/containers";
      ...
      //			sb2.append("<om2m:container xmlns:om2m='http://uri.etsi.org/m2m'

      //om2m:id='" + dataContainerID2 + "'>");
      ...
      //			sb2.append("<om2m:searchString>ResourceID/" + DeviceID2 + "_Temp_" +

      //dataContainerID2 + "</om2m:searchString>");
      ...
      //			httpMethod3.addRequestHeader("Authorization", "Basic
      ...
      //			sb3.append("<om2m:application xmlns:om2m='http://uri.etsi.org/m2m'

      //appId='" + DeviceID3 + "_Temp'>");
      ...
      //			sb3.append("<om2m:searchString>ResourceID/" + DeviceID3 +
      ...
      //			requestEntity3 = new StringRequestEntity(sb3.toString(),
      ...
      //"/om2m/gscl/applications/" + DeviceID3 + "_Temp/containers";
      ...
      //			sb3.append("<om2m:container xmlns:om2m='http://uri.etsi.org/m2m'

      //om2m:id='" + dataContainerID3 + "'>");
      ...
      //			sb3.append("<om2m:searchString>ResourceID/" + DeviceID3 + "_Temp_" +

      //dataContainerID3 + "</om2m:searchString>");
          ...
          try {
            ...
            try {
              ...
              String url = "http://" + GSCL_IP + ":" + GSCL_Port + "/om2m/gscl/applications/"
                  ...
                  + DeviceID + "_Temp/containers/" + dataContainerID + "/contentInstances";
              ...
              // sb.append("<str name='data' val='" + str_generator(iDataSize, i) + "'/>");
               ...
               sb.append("<str name='data' val='" + foo(iDataSize, i) + "'/>");

              // 2021.11.15

              //sb.append("<str name='data' val='" + 20 + "'/>");

              // here change the random range 2021.5.17



              //							sb.append("<str name='data'

              //val='" + str_generator(randomdatasize, i) + "'/>");
              ...
              StringRequestEntity requestEntity =
                  ...
                  new StringRequestEntity(sb.toString(), "application/xml", "UTF-8");
            ...
            //						String test="gscl/applications/" + DeviceID +
            ...
            //						String urltest = "http://" + GSCL_IP + ":" + GSCL_Port + "/om2m/" +

            //test;



            //						HttpClient httpclientTest = new

            //HttpClient();



            //						GetMethod httpMethodTest = new

            //GetMethod(urltest);



            //						httpMethodTest.addRequestHeader("Authorization", "Basic
            ...
            //httpclientTest.executeMethod(httpMethodTest);
            ...
            //httpMethodTest.getResponseBodyAsString();
            ...
            //tmp=strBody.split("<om2m:contentSize>");



            //						String

            //output=tmp[1].split("</om2m:contentSize>")[0];
