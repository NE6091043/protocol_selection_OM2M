...
class DQN:
    def __init__(
        ...
        self.load_model("checkpoints/dqn0520query")
        ...
        self.cost_his = self.loadcost_his("cost_hist/dqn0520costhisquery")
...
agent.step = agent.load_step("cost_hist/dqn0520stepquery")
...
if __name__ == '__main__':
    ...
    agent.saved_model("checkpoints/dqn0520query")
    agent.savecost_his("cost_hist/dqn0520costhisquery")
    agent.save_step("cost_hist/dqn0520stepquery")
    agent.plot_loss()
