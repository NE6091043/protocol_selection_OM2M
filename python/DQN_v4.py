...
def start_decision():
    ...
    def decision():
        ...
        # s=np.array([idx, agent.action])
        s = np.array([prev_time_protocol, datasize, env_loss, env_bandwidth])
        ...
        #     changeprotocol("xmpp")
        changeprotocol("xmpp")
        s_ = np.array([a, datasize, env_loss, env_bandwidth])
        # print("-----------------")
        # print("-----------------")
        # print("-----------------")
        # print(s)
        ...
        agent.store_transition(s, a, reward, s_)
