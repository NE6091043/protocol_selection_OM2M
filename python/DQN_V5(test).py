...
class DQN:
    def __init__(
        ...
        self.load_model("checkpoints/mode0507_query")
        ...
        self.cost_his = self.loadcost_his("cost_hist/0507querycost_hist")
...
agent = DQN(4, 4, e_greedy=1.0,
            replace_target_iter=200,
            memory_size=5000,
            output_graph=True
            )
# agent.step = agent.load_step("cost_hist/0507query_step")
...
if __name__ == '__main__':
    ...
    # agent.saved_model("checkpoints/mode0507_query")
    # agent.savecost_his("cost_hist/0507querycost_hist")
    # agent.save_step("cost_hist/0507query_step")
    # agent.plot_loss()
