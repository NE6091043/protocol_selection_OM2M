...
class DQN:
    def __init__(
        ...
        self.cost_his = self.loadcost_his("cost_hist/"+filename+"querycosthis")
...
agent.step = agent.load_step("cost_hist/"+filename+"dqn06xxquerystep")
...
if __name__ == '__main__':
    ...
    if begin_plot == 1:
        ...
        agent.savecost_his("cost_hist/"+filename+"querycosthis")
        agent.save_step("cost_hist/"+filename+"querystep")
