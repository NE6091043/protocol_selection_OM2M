...
class QLearningTable:
    ...
    def save_sarsatable(self, filename):
        self.q_table.to_pickle(filename)

    def load_sarsatable(self, filename):
...
agent.load_sarsatable("0506_event_sarsa")
...
def state_post():
    ...
    if flag == False:
        reward = -1000
    # if st_0 != [0, 0.0, 0]:
    #     agent.learn(str(st_0), at_0, reward, str(st_1), at_1)
    flag = False
    st_0[0] = st_1[0]
    st_0[1] = st_1[1]
    st_0[2] = st_1[2]
...
if __name__ == '__main__':
    ...
    # agent.save_sarsatable("0506_query_sarsa")
